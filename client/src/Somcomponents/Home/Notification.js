...
import { fetchSomNotifications } from "./../../actions/index";
...
class Notifications extends Component {
  ...
  componentDidMount() {
    this.props.fetchSomNotifications();
  }
...
const mapStateToProps = (state) => {
  // console.log(state.notifications_som);
  return {
    notification: state.notifications_som,
    auth: state.auth,
  };
};
...
export default connect(mapStateToProps, {
  fetchSomNotifications: fetchSomNotifications,
