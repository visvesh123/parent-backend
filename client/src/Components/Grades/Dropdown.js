...
const Dropdown = (props) => {
  ...
  const arr = [
    { type: "1-1", value: 1, label: "First year" },
    { type: "1-2", value: 2, label: "First year" },
    { type: "2-1", value: 3, label: "Second year" },
    { type: "2-2", value: 4, label: "Second year" },
    { type: "3-1", value: 5, label: "Third year" },
    { type: "3-2", value: 6, label: "Third year" },
    { type: "4-1", value: 7, label: "Fourth year" },
    { type: "4-2", value: 8, label: "Fourth year" },
  ];

  if (!props.minor1[0]) return null;
  if (!props.minor2[0]) return null;
  if (!props.final[0]) return null;
